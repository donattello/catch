        ...
        <section class="chatWindow">
            <div class="stage">
                <div class="chatSpeech col-xs-6">
                    <img src="images/chatMockup/chat1.png" class="img-responsive">
                </div>
            </div><!--end of stage-->
            
<!--
            <div class="chatText col-xs-12">
                <div class=" chatTextWindow col-xs-8">
                    <div class="input-group">
                        <input type="text" class="form-control col-xs-12" aria-describedby="basic-addon1">    
-->
<!--                   </div><!--end of chatTextWindow-->
<!--
                </div>
                <div class="sendBtn col-xs-2">
