...
/**
 * Base class that represents a query for the 'sport' table.
 *
 *
 *
 * @method     ChildSportQuery orderById($order = Criteria::ASC) Order by the id column
 * @method     ChildSportQuery orderBySport($order = Criteria::ASC) Order by the sport column
 *
 * @method     ChildSportQuery groupById() Group by the id column
 * @method     ChildSportQuery groupBySport() Group by the sport column
 *
 ...
 *
 * @method     ChildSportQuery leftJoinEvent($relationAlias = null) Adds a LEFT JOIN clause to the query using the Event relation
 * @method     ChildSportQuery rightJoinEvent($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Event relation
 * @method     ChildSportQuery innerJoinEvent($relationAlias = null) Adds a INNER JOIN clause to the query using the Event relation
 *
 ...
 * @method     ChildSport findOneBySport(string $sport) Return the first ChildSport filtered by the sport column *
 ...
 * @method     ChildSport requireOneBySport(string $sport) Return the first ChildSport filtered by the sport column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildSport[]|ObjectCollection findBySport(string $sport) Return ChildSport objects filtered by the sport column
...
abstract class SportQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\SportQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Sport', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, sport FROM sport WHERE id = :p0';
        try {
     ...
     * $query->filterBySport('%fooValue%'); // WHERE sport LIKE '%fooValue%'
     * </code>
     *
    ...
    public function filterBySport($sport = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SportTableMap::COL_SPORT, $sport, $comparison);
    }
    ...
    public function filterByEvent($event, $comparison = null)
    {
        if ($event instanceof \Event) {
            return $this
                ->addUsingAlias(SportTableMap::COL_ID, $event->getEventType(), $comparison);
    ...
    /**
     * Deletes all rows from the sport table.
     *
