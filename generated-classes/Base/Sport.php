...
/**
 * Base class that represents a row from the 'sport' table.
 *
 *
 *
...
abstract class Sport implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\SportTableMap';
    ...
    /**
     * Initializes internal state of Base\Sport object.
     */
     ...
     * @return $this|\Sport The current object (for fluent API support)
     */
    ...
    public function setSport($v)
    {
        ...
        if ($this->sport !== $v) {
            $this->sport = $v;
            $this->modifiedColumns[SportTableMap::COL_SPORT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SportTableMap::translateFieldName('Sport', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = SportTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Sport'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SportTableMap::COL_SPORT)) {
            $modifiedColumns[':p' . $index++]  = 'sport';
        }

        $sql = sprintf(
            'INSERT INTO sport (%s) VALUES (%s)',
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SportTableMap::COL_SPORT)) {
            $criteria->add(SportTableMap::COL_SPORT, $this->sport);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Sport (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Sport Clone of current object.
     * @throws PropelException
     */
